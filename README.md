...
```bash
go get github.com/Karotte128/KarotteAPI/v3
```
...
```go
import (
    _ "github.com/Karotte128/KarotteAPI/v3/builtins" // Enable builtin middlewares and modules. Highly recommended!
...
```go
import (
    _ "github.com/Karotte128/KarotteAPI/v3/builtins"
)
```
...
import (
	...
	"github.com/karotte128/apiutils/v3/config"
	"github.com/karotte128/karotteapi/v3/api"
	_ "github.com/karotte128/karotteapi/v3/builtins"
)
